...
class _WorkScheduleScreenState extends State<WorkScheduleScreen> {
  ...
  void initState() {
    super.initState();
    _fetchUserScheduleAndArea();
  }

  Future<void> _fetchUserScheduleAndArea() async {
    try {
      ...
      final assignedArea = userData['assignedArea']
          ?.toString(); // Changed to area
      final scheduleStr = userData['schedule'] as String?;
      final employmentType = userData['employmentType'] as String?;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Area - CHANGED FROM UNIT TO AREA
                          Text(
                            'AREA ${_area ?? "N/A"}',
                            style: TextStyle(
                              color: Colors.white,
